const Privacy = () => {
  const HeaderStyle = "text-[30px] font-bold text-stone-900";
  const SmallHeaderStyle = "text-[24px] font-semibold text-stone-900";
  const spanStyle = "font-semibold text-stone-900 ";

  return (
    <div className="max-w-7xl mx-auto flex flex-col items-start pt-12 p-3">
      <h1 className={HeaderStyle}>PRIVACY POLICY</h1>
      <div>
        <p>
          <br />
        </p>
        <p className={spanStyle}>Last updated July 18, 2023</p>
        <p>
          <br />
        </p>
        <p>
        ...
        <p>
          This privacy notice for Unravel Technologies PLC (&quot;we,&quot;
        ...
        <ul>
          <li>
            <p>
              ...
              <a href="https://lively-et.com/">https://lively-et.com</a>, or any
              website of ours that links to this privacy notice
            </p>
          </li>
          <li>
            <p>
              Download and use our mobile application (Lively: A Better Living),
        ...
        <h3 className={SmallHeaderStyle}>SUMMARY OF KEY POINTS</h3>
        <p>
          <br />
        </p>
        <p>
        ...
        <p>
          ...
          <a href="https://lively-et.com/contact">
            https://lively-et.com/contact
          </a>
        ...
        <h4 className={SmallHeaderStyle}>TABLE OF CONTENTS</h4>
        <p>
          <br />
        </p>
        ...
        <p>
          <a href="https://app.termly.io/dashboard/website/027896d5-d200-4109-bf2f-aa85f9303205/privacy-policy#caresidents">
        ...
        <h4 className={SmallHeaderStyle}>1. WHAT INFORMATION DO WE COLLECT?</h4>
        <p>
          <br />
        </p>
        ...
        <p>
          ...
          payment data is stored by Telebirr. You may find their privacy notice
          link(s) here:&nbsp;
          <a href="https://www.ethiotelecom.et/privacy-policy/">
            https://www.ethiotelecom.et/privacy-policy/
          </a>
          .
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              your mobile device, your mobile device&rsquo;s operating system or
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              requests. This includes: Current device location; and other
              ...
              &quot;HOW DO WE PROCESS YOUR INFORMATION?&quot;. The Google Maps
        ...
        <p>
          ...
          please contact us at contact@lively-et.com.
        </p>
        <p>
          <br />
        </p>
        <h4 className={SmallHeaderStyle}>9. WHAT ARE YOUR PRIVACY RIGHTS?</h4>
        <p>
          <br />
        </p>
        <p>
        ...
        <p>
          ...
          email us at&nbsp;contact@lively-et.com.
        </p>
        <p>
          <br />
        </p>
        ...
        <p>
          You may contact us by email at contact@lively-et.com, by
          visiting&nbsp;
          <a href="https://lively-et.com/contact">
            https://lively-et.com/contact
          </a>
        ...
        <p>
          ...
          contact@lively-et.com, by visiting&nbsp;
          <a href="https://lively-et.com/contact">
            https://lively-et.com/contact
          </a>
          , or by referring to the contact details at the bottom of this
        ...
        <p>
          ...
          submit the request through an authorized agent, we may need to collect
        ...
        <p>
          ...
          decision, please email us at contact@lively-et.com. Within sixty (60)
        ...
        <p>
          ...
          at contact@lively-et.com or contact us by post at:
        </p>
        <p>
          <br />
        </p>
        <p>Unravel Technologies PLC</p>
        <p>Bole DH-Geda Tower 7th Floor No. 705</p>
        <p>Addis Ababa,&nbsp;Addis Ababa&nbsp;</p>
        <p>Ethiopia</p>
        <p>
          <br />
        </p>
